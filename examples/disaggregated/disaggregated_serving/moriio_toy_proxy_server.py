...
def example_prefill_request_number(request_number, num_prefill_instances):
    return ((request_number - 1) // num_prefill_instances) + 1
...
def select_request_dp_ranks(
    ...
    prefill_request_number = example_prefill_request_number(
        request_number, num_prefill_instances
    )
    return (
        example_round_robin_dp_loader(
            prefill_request_number,
